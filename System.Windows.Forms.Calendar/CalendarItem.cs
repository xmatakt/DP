...
namespace System.Windows.Forms.Calendar
{
        ...
        : CalendarSelectableElement
    {
        ...
        /// <param name="startDate">Start date of the item</param>
        /// <param name="endDate">End date of the item</param>
        /// <param name="text">Title of the item</param>
        /// <param name="description">Description of the item</param>
        /// <param name="isDeleted">State of the item</param>
        public CalendarItem(Calendar calendar, DateTime startDate, DateTime endDate, string text, string description, bool isDeleted)
            : this(calendar)
        {
            StartDate = startDate;
            EndDate = endDate;
        ...
        {
            get { return _databaseEntityID; }
            set { _databaseEntityID = value; }
        }
        ...
        {
            get { return _googleEventID; }
            set { _googleEventID = value; }
        }
        ...
        {
            GoogleEventID = StartDate.Date.ToString("ddMMyyyy") + "id" + DatabaseEntityID;
        }
